...
import type { CompilerInput } from '../core/compiler-contract.js';
import type { RequirementDefinition } from '../core/requirements.js';
import type { Proposition } from '../core/propositions.js';

export const COMPILER_INPUT_RENDER_VERSION = 'juryai-compiler-input-render-v0.2.0';
