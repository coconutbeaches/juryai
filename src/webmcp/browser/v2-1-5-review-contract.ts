import type { PartyReviewStateV215 } from '../../v2-1-5/party-review-state.js';
import {
  EPISTEMIC_STRENGTHS,
  HASH_PATTERN,
  ID_PATTERN,
...
export interface ParsedFirstPartyReviewV215 {
...
export interface ParsedInvitationRedemptionV215 {
  status: 'redeemed';
  review_path: string;
}
...
export function decodeInvitationRedemptionV215(value: unknown): ParsedInvitationRedemptionV215 {
...
function validateFormationProjection(
  ...
  if (projection.projection_version !== 'juryai-party-formation-projection-v2.1.5') {
...
export function decodeFirstPartyReviewV215(value: unknown): ParsedFirstPartyReviewV215 {
  ...
  if (page.review_page_version !== 'juryai-v2.1.5-first-party-review-page-v1.0.0') {
  ...
  if (
    ...
    review.formation_projection_version !== 'juryai-party-formation-projection-v2.1.5' ||
    review.formation_readback_version !== 'juryai-party-formation-readback-v2.1.5' ||
    projection.party_id !== review.party_id ||
    projection.case_id !== review.dispute_id ||
    readback.party_id !== review.party_id ||
    readback.readback_version !== 'juryai-party-formation-readback-v2.1.5' ||
  ...
  return {
    ...
    review: review as unknown as PartyReviewStateV215,
    workflow_phase: workflow as ParsedFirstPartyReviewV215['workflow_phase'],
    disclosure_state: page.disclosure_state,
    own_disclosure_review:
      page.own_disclosure_review as ParsedFirstPartyReviewV215['own_disclosure_review'],
    can_acknowledge_disclosure_review: boolean(
