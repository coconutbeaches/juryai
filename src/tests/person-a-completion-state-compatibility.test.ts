...
describe('Person A completion-state compatibility', () => {
  ...
  it.each([
    ...
    ['The client says the booking page is incomplete.', 'complete'],
    ['The client says the booking page is incomplete, but I consider it complete.', 'complete'],
    ['The booking page and the shopping cart page are complete.', 'complete'],
    ["I didn't complete the booking page until Friday.", 'complete'],
    ['The booking page is still a draft.', 'substantially_complete'],
    ['The booking page is complete. The client says no pages are complete.', 'complete'],
    ['I am not sure whether the booking page is still a draft.', 'unknown'],
    ['I dispute that the booking page is still a draft.', 'disputed'],
    ['The booking page was incomplete yesterday, however it is complete now.', 'complete'],
    ['The mobile booking page is incomplete.', 'complete'],
    ['The booking page was delivered.', 'complete'],
    ['The booking page was finalized.', 'complete'],
    ["The booking page wasn't completed until Friday.", 'complete'],
    ...
    ['According to my assessment, the booking page is incomplete.', 'partially_complete'],
    ['According to our review, the booking page is unfinished.', 'partially_complete'],
    ['The booking page is anything but complete.', 'not_complete'],
    ["I haven't started the booking page.", 'not_complete'],
    ["Work hasn't begun on the booking page.", 'not_complete'],
    ['Not a single page is complete.', 'not_complete'],
    ['Neither page is complete.', 'not_complete'],
    ['The client told me the booking page is incomplete.', 'complete'],
    ['The booking page is no longer incomplete.', 'complete'],
    ['The booking page was incomplete and later completed.', 'complete'],
    ['The booking page is complete now, but it was incomplete yesterday.', 'complete'],
    ['I completed the booking page header.', 'unknown'],
    ['I completed the booking page design.', 'unknown'],
    ['I completed the booking page draft.', 'unknown'],
    [
      'The booking page is complete now, but the booking page was incomplete yesterday.',
      'complete',
    ],
    ['I was told that the booking page is incomplete.', 'complete'],
    ['The client informed me that the booking page is incomplete.', 'complete'],
    ['The booking page is not only complete but also deployed.', 'complete'],
    ['The homepage, not the booking page, is complete.', 'unknown'],
    ['Alex, the client, says the booking page is incomplete.', 'complete'],
    ['I did not say that the booking page was complete.', 'unknown'],
    ...
    ['No one completed the booking page.', 'not_complete'],
    ['Nobody finished the booking page.', 'not_complete'],
    ['None of us delivered the booking page.', 'not_complete'],
    ['Neither Alex nor I completed the booking page.', 'not_complete'],
    ['The booking page is complete now. All pages were incomplete yesterday.', 'complete'],
  ...
  it.each([
    "I don't doubt that the booking page is complete.",
    'I did not question whether the booking page was complete.',
  ])('preserves completion under negated uncertainty: %s', (narrative) => {
  ...
  it("does not apply another deliverable's completion state to the target", () => {
