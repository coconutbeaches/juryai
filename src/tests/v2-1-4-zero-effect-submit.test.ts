...
function baseEnvelope(): CaseEnvelopeV214 {
  let envelope = createInitialCaseEnvelopeV214(unique('dispute_zero_effect'), {
...
function serviceFor(
  ...
  return createV214PartyCaseService({
...
async function get(service: V214PartyCaseService, disputeId: string) {
