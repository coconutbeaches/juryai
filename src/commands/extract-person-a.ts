...
import { personAProvenanceCaseIdForNarrative } from '../extraction/person-a-provenance-cases.js';
...
export async function runExtractPersonACommand(
  ...
  const provenanceCaseId = personAProvenanceCaseIdForNarrative(narrative);
